export default {
  translation: {
    ...
    GameScreenPositionDesc: 'ゲーム映像を画面の上・中央・下に寄せます。',
    Top: '上寄せ',
    Center: '中央',
    Bottom: '下寄せ',
    ...
    GfnLaunchInvalidApp:
      'このタイトルは起動できません（アプリ ID が不正です）。',
    GfnLaunchSignInRequired: 'まず GeForce NOW にサインインしてください。',
    GfnLaunchRequesting: 'ゲームセッションを要求しています…',
